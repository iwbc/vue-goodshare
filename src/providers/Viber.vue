<template>
  ...
  >
    <i class="icon-viber" v-if="this.$props.has_icon"></i>
...
@font-face {
  ...
  src: url("../fonts/fontello.eot?77148853");
  src: url("../fonts/fontello.eot?77148853#iefix") format("embedded-opentype"),
       url("../fonts/fontello.woff2?77148853") format("woff2"),
       url("../fonts/fontello.woff?77148853") format("woff"),
       url("../fonts/fontello.ttf?77148853") format("truetype"),
       url("../fonts/fontello.svg?77148853#fontello") format("svg");
  font-weight: normal;
  font-style: normal;
}
...
// Colors
$viber_main_color: rgb(89, 38, 124);
$gradient_color: rgb(119, 68, 154);
...
.viber__design__flat {
  background-color: $viber_main_color;
...
.viber__design__outline {
  ...
  border: 1px solid $viber_main_color;
  color: $viber_main_color;
}
